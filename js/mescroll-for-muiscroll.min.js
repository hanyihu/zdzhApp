...
function MeScroll(a, c, g) {
	...
	f.muiScroll = mui("#" + a).scroll(g);
	f.muiScrollContent = f.scrollDom.getElementsByClassName("mui-scroll")[0];
	if (!f.muiScrollContent) {
		console.error(
			'the element with classname as "mui-scroll" can not be found: document.getElementsByClassName("mui-scroll")==null');
		return
	}
	f.options = c || {};
	var d = navigator.userAgent;
	var b = !!d.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
	var h = typeof window.orientation == "undefined";
	var e = d.indexOf("Android") > -1 || d.indexOf("Adr") > -1;
	f.os = {
		ios: b,
		pc: h,
		android: e
...
MeScroll.prototype.initDownScroll = function() {
	...
	if (b.optDown.use) {
		...
		var a = b.optDown.warpId ? b.getDomById(b.optDown.warpId) : b.muiScrollContent;
		if (b.optDown.warpId && a) {
			a.appendChild(b.downwarp)
		} else {
			if (!a) {
				a = b.muiScrollContent
			}
			a.insertBefore(b.downwarp, b.muiScrollContent.firstChild)
		}
		setTimeout(function() {
...
MeScroll.prototype.scrollTo = function(b, a) {
	a = a || 300;
	this.muiScroll.scrollTo(0, b, a)
};
